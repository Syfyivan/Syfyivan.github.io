  ...
  function stageFamily() {
    ...
    function familyRoutePack() {
      ...
      if (route.indexOf('路径四') === 0 || route.indexOf('徽商') === 0) {
        ...
        pack.dossier = '累计反哺=' + S.累计反哺银 + '两｜未回款=' + S.未回款银 + '两｜商路供读=' + S.商路供读银 + '两｜账房=' + S.账房进度 + '｜信誉=' + S.商信誉;
        pack.event = { t: 'rand', tag: '[商路]', txt: xun === 2
        ...
        pack.note = '学徒路成家后也不只是“在铺里站着”：铺里脚钱能不能捎回家、师门旧识还认不认你、哪一口人情能先替你打听差役，都会改写这一旬家计。';
        pack.dossier = '学徒去向=' + S.学徒去向 + '｜授艺度=' + S.学徒授艺度 + '｜学徒历练=' + S.学徒历练;
        pack.event = { t: 'rel', tag: '[铺面]', txt: xun === 2 ? '这一旬最像“铺里脚钱怎么回家”：你若真在城里站住过，带回家的不只是钱，还有门路。' : (xun === 3 ? '下旬更像把旧掌柜、同门和铺里零碎脚钱一起翻出来：哪口钱先结、哪口人情先用，都是真后手。' : '成家后仍吃铺里这碗饭，最怕的是家里只知道你在外头忙，却看不见哪笔钱真回来了。') };
        if (xun === 1) {
          pack.extraActions.push({
        ...
        pack.note = '举业路成家后要把“体面”和“家计”同时算：笔墨底子若只停在文案里，家里这一旬就真会翻锅。先问馆课和保结、再把代写文契换成现钱、再把馆课钱与差役后手一旬旬拢回来，才算把这一路真的活进成年阶段。';
        ...
        if (xun === 1) {
          pack.extraActions.push({
            ...
            cost: 1,
            eff: '铜钱-40·问馆课·家族+1',
            desc: '先托塾师、学生家与保结人问清今季有没有馆课、谁还肯替你作保。钱还没回，可哪口笔墨活能接、哪层人情能用，先被你摸实了一层。',
            can: S.铜钱 >= 40,
            why: S.铜钱 >= 40 ? '' : '铜钱不足40文'
          });
        }
        if (xun === 2 && (S.识字 || S.识字转业值 >= 1)) {
          pack.extraActions.push({
            ...
            desc: '替邻里、地主或铺面抄契写单，把识字底子真的换成一点现钱。',
            can: true
          });
        }
        if (xun === 3) {
          pack.extraActions.push({
            ...
            desc: '把前两旬应得的馆课钱、抄写钱和学生家的零碎束脩真正结回一点。不是凭空多一笔，只把该到家的那口钱拢回来。',
            can: (S.识字 || S.识字转业值 >= 1),
          ...
          pack.extraActions.push({
            ...
            cost: 1,
            eff: '铜钱-60·家族+1·备役+1',
            desc: '先托塾师、廪保和学生家问清这一年差役与请托路数。不是到催差那天才求人，而是先把“读书认得的人”压进后手里。',
            can: S.铜钱 >= 60,
            why: S.铜钱 >= 60 ? '' : '铜钱不足60文'
          });
        }
      } else if (route.indexOf('路径二') === 0 || route.indexOf('受雇') === 0) {
        pack.note = '卖工路成家后最要紧的是“哪一口工食先回家”，而不是年底总共写了多少工钱。';
        pack.dossier = '雇技进度=' + S.雇技进度 + '｜雇工历练=' + S.雇工历练 + '｜婚配路径=' + S.婚配路径;
        pack.event = { t: 'rel', tag: '[工食]', txt: xun === 2 ? '中旬最像把工钱往家里拢：自己手里少一点，家里那口锅却能先续上。': '成家后卖工最怕的不是工钱少，而是钱在你手上没来得及拢回家，家里就先断了。' };
        if (xun === 2) {
          pack.extraActions.push({
            id: 'f_route_send',
            name: '托工头先捎工食',
        ...
        lifePicks.forEach(function (p) {
          switch (p.id) {
            ...
            case 'f_route_write':
              ...
              log.push(['代写文契补家计：铜钱+' + writeGain + '、识字转业值+1。笔墨底子终于不只停在体面话里。', 'good']);
              break;
            case 'f_route_school_note':
              if (spendCopper(40)) {
                ...
                log.push(['先问馆课与保结门路：铜钱-40、家族+1。馆课和保结都还没落到手里，可哪家要开蒙、哪位廪保肯说话，先被你摸清了一层。', 'good']);
            ...
            case 'f_route_tutor_collect':
              ...
              log.push(['结回馆课与抄写钱：铜钱+' + tutorCollectGain + ((S.本年家捎信 || 0) > 0 ? '。前头先问过馆课和保结，这口钱回得更实。' : '。这不是凭空添一笔，只把该你的笔墨钱真正拢回家计。'), 'good']);
              break;
            case 'f_route_surety':
              if (spendCopper(60)) {
                S.家族 += 1;
                ...
                log.push(['凭塾师保结先探差役：铜钱-60、家族+1、备役后手+1。不是到催差那天才求人，而是先把塾师、廪保和学生家这层门路压进后手里。', 'good']);
