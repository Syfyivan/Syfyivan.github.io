        ...
        lifePicks.forEach(function (p) {
          ...
          switch (p.id) {
            ...
            case 'e_brother_help':
              ...
              S.本年家中供读次 += 1;
              S.本年延婚牵扯 += 1;
              pushExamSeasonTag(stepTag + '兄婚让读');
              log.push([brotherHelpName + '：铜钱+' + brotherHelpCopper + '、供读压力-1、家族-2。兄房明着把原想留给婚事、年礼或置办的一口钱先让出来，才替你续住这一旬纸墨与门路；兄并不是默认让钱，这层牵扯也已在同一年里见了账。', 'bad']);
              break;
            case 'e_home':
