(function () {
  ...
  // Plan B（川进滇出）路段说明：与 days.js 的 29 天骨架对应。
  const segmentNotes = {
  ...
  const pois = [
    // —— 全程 19 个住宿（川进滇出，29天，10/4 出发；多次入住的酒店合并为一条）——
    { id: 'stay-pingyao', category: 'stay', name: '平遥一得客栈', lng: 112.180, lat: 37.204, area: 'D1·D28 平遥', note: '10月4日与10月31日各1晚；客栈房2间，古城外停车步行入住。' },
    { id: 'stay-xian', category: 'stay', name: '西安千浔民宿', lng: 109.008616, lat: 34.332446, area: 'D2·D27 西安', note: '10月5日与10月30日各1晚；首选两室一厅整套房，可做饭，停车另收费。', bookingUrl: 'https://us.trip.com/hotels/xi-an-hotel-detail-78099745/xi-an-qianxun-homestay/' },
    { id: 'stay-guangyuan', category: 'stay', name: '广元利州皇冠假日酒店', lng: 105.843357, lat: 32.435435, area: 'D3 广元', note: '10月6日，1晚；酒店2间。入蜀翻秦岭后落脚，次日顺路看剑门关。' },
    { id: 'stay-chengdu', category: 'stay', name: '玖境 ZEN9·设计师套房公寓', lng: 104.086899, lat: 30.653489, area: 'D4·D26 成都', note: '10月7日与10月29日，共2晚；首选90㎡双卧整套房，厨房洗衣机齐全，进川藏前大补给。', bookingUrl: 'https://www.trip.com/hotels/chengdu-hotel-detail-123334753/ninth-realm-designer-suites-residences/' },
    { id: 'stay-xinduqiao', category: 'stay', name: '康定新都桥318国道亚朵酒店', lng: 101.513562, lat: 30.033208, area: 'D5 新都桥', note: '10月8日，1晚；供氧2间可分住，翻折多山后第一晚上高原。' },
    { id: 'stay-litang', category: 'stay', name: '理塘雅砻酒店', lng: 100.263451, lat: 29.985148, area: 'D6·D9 理塘', note: '10月9日与10月12日各1晚；全屋供氧+地暖，世界高城恢复夜，进出亚丁各住一晚。' },
    { id: 'stay-riwa', category: 'stay', name: '念想酒店（稻城亚丁景区店）', lng: 100.348112, lat: 28.558377, area: 'D7·D8 日瓦/香格里拉镇', note: '10月10—12日，连住2晚；供氧双床房2间，覆盖亚丁长线徒步日。' },
    { id: 'stay-batang', category: 'stay', name: '巴塘蜀巴大酒店', lng: 99.109509, lat: 30.004452, area: 'D10 巴塘', note: '10月13日，1晚；酒店2间。海拔降到2500m，进藏前难得的低海拔恢复夜。' },
    { id: 'stay-zogang', category: 'stay', name: '左贡维尔纳国际酒店', lng: 97.841148, lat: 29.669777, area: 'D11·D20 左贡', note: '10月14日与10月23日各1晚；酒店2间含早，进出藏各住一晚。' },
    { id: 'stay-baxoi', category: 'stay', name: '全季酒店（昌都八宿县店）', lng: 96.931548, lat: 30.058649, area: 'D12 八宿', note: '10月15日，1晚；酒店2间，过怒江72拐后收车点。' },
    { id: 'stay-bomi', category: 'stay', name: '全季酒店（波密县店）', lng: 95.760998, lat: 29.859889, area: 'D13 波密', note: '10月16日，1晚；酒店2间，然乌米堆后低海拔恢复夜。' },
    { id: 'stay-linzhi', category: 'stay', name: '林芝悦皇冠度假酒店', lng: 94.376175, lat: 29.604960, area: 'D14·D18 林芝', note: '10月17日与10月21日各1晚；酒店2间，坐标核到八一镇阿杰路，进出拉萨各住一晚。' },
    { id: 'stay-lhasa', category: 'stay', name: '如家酒店·neo（大昭寺八廓街店）', lng: 91.148678, lat: 29.649323, area: 'D15—D17 拉萨', note: '10月18—21日，连住3晚；供氧房2间，深度恢复+机动日+车辆保养。' },
    { id: 'stay-ranwu', category: 'stay', name: '然乌蓝湖驿站', lng: 96.75225, lat: 29.503373, area: 'D19 然乌镇', note: '10月22日，1晚；供氧客房2间，住湖边补看米堆/然乌。' },
    { id: 'stay-markam', category: 'stay', name: '芒康康愿假日酒店', lng: 98.598025, lat: 29.685725, area: 'D21 芒康', note: '10月24日，1晚；全屋地暖2间，川藏与滇藏的分岔点。' },
    { id: 'stay-feilaisi', category: 'stay', name: '德钦飞来寺梅里往事酒店', lng: 98.877466, lat: 28.437903, area: 'D22 飞来寺', note: '10月25日，1晚；客房2间，靠日照金山观景动线。' },
    { id: 'stay-shangrila', category: 'stay', name: '卓越逸墅 EaseVilla·全屋供氧度假美宿', lng: 99.698889, lat: 27.858264, area: 'D23 香格里拉', note: '10月26日，1晚；整套两居或客房2间可分住（全屋供氧，高海拔恢复优先）。' },
    { id: 'stay-lijiang', category: 'stay', name: '丽江蓝汐君临民宿', lng: 100.246, lat: 26.876, area: 'D24 丽江', note: '10月27日，1晚；首选171㎡两卧三卫带厨房整套房，免费停车，适合4人做饭与洗衣。', bookingUrl: 'https://www.trip.com/hotels/lijiang-hotel-detail-127173268/lijianglanxijunlin/' },
    { id: 'stay-xichang', category: 'stay', name: '西昌邛海亚朵酒店', lng: 102.267537, lat: 27.881407, area: 'D25 西昌', note: '10月28日，1晚；酒店2间。海拔降到1500m，晚上吃西昌烧烤。' },
    ...
    { id: 'scene-barkhor', category: 'scenic', name: '拉萨八廓街 / 布达拉宫广场', lng: 91.13, lat: 29.65, area: '拉萨', note: 'D16—D17恢复日轻量步行，不爬高不赶点。' },
    { id: 'scene-tibetmuseum', category: 'scenic', name: '西藏博物馆', lng: 91.108, lat: 29.6497, area: '拉萨', note: 'D16下午参观，罗布林卡路34号、布达拉宫西侧顺路；免费但需提前1—7天预约，周一闭馆，10/19周日旺季开到18:30，留约2小时。' },
  ...
  // —— 住宿价格（4人当晚总价区间，元）——
  // Plan B 为国庆假期内（10/4起）出发，10/4—10/6 头三晚（平遥/西安/广元）撞国庆价偏高，
  // 进藏后与回程逐步回落到淡季；价格按此规划估算，出发前须用订单页与实时地图逐项复核，不代表锁定报价。
  const CHECKED = '2026-08-19';
  const STAY_PRICES = {
    'stay-pingyao':      { p: [480, 680], n: '国庆价规划估算', inc: '客栈2间可分住（大床）；古城内，往返两次入住（去程撞国庆、回程10/31淡季）', cid: 104, ci: '2026-10-04', co: '2026-10-05' },
    'stay-xian':         { p: [420, 720], n: '国庆价规划估算', inc: '首选两室一厅整套（4人一套），可做饭；或2间可分住，往返两次入住', cid: 10, ci: '2026-10-05', co: '2026-10-06' },
    'stay-guangyuan':    { p: [420, 620], n: '国庆价规划估算', inc: '2间可分住（大床+双床）；市区商务酒店', cid: 226, ci: '2026-10-06', co: '2026-10-07' },
    'stay-chengdu':      { p: [400, 700], n: '规划估算价', inc: '首选90㎡双卧整套（4人一套），厨房洗衣机齐全；共2晚（进藏1+回程1）', cid: 28, ci: '2026-10-07', co: '2026-10-08' },
    'stay-xinduqiao':    { p: [480, 700], n: '淡季规划估算价', inc: '供氧2间可分住（大床+双床）；318国道连锁', cid: 4130, ci: '2026-10-08', co: '2026-10-09' },
    'stay-litang':       { p: [520, 780], n: '淡季规划估算价', inc: '2间可分住；全屋供氧+地暖，县城中心，往返两次入住', cid: 20972, ci: '2026-10-09', co: '2026-10-10' },
    'stay-riwa':         { p: [400, 680], n: '淡季规划估算价', inc: '供氧2间可分住（大床+双床，连住2晚）；亚丁景区落点', cid: 1222, ci: '2026-10-10', co: '2026-10-12' },
    'stay-batang':       { p: [320, 480], n: '规划估算价', inc: '2间可分住；县城酒店，低海拔恢复夜', cid: 21836, ci: '2026-10-13', co: '2026-10-14' },
    'stay-zogang':       { p: [460, 640], n: '淡季规划估算价', inc: '2间可分住（供氧大床+双床）；县城酒店含早，往返两次入住', cid: 21163, ci: '2026-10-14', co: '2026-10-15' },
    'stay-baxoi':        { p: [420, 600], n: '淡季规划估算价', inc: '供氧房2间可分住（大床+双床）；县城连锁', cid: 21120, ci: '2026-10-15', co: '2026-10-16' },
    'stay-bomi':         { p: [480, 720], n: '淡季规划估算价', inc: '2间可分住（大床+双床，住1晚）；低海拔恢复', cid: 21979, ci: '2026-10-16', co: '2026-10-17' },
    'stay-linzhi':       { p: [360, 580], n: '淡季规划估算价', inc: '2间可分住（大床+双床）；度假酒店含停车充电，往返两次入住', cid: 108, ci: '2026-10-17', co: '2026-10-18' },
    'stay-lhasa':        { p: [420, 600], n: '淡季规划估算价', inc: '供氧房2间可分住（住3晚）；深度恢复+机动日+保养', cid: 41, ci: '2026-10-18', co: '2026-10-21' },
    'stay-ranwu':        { p: [440, 600], n: '淡季规划估算价', inc: '供氧客房2间可分住；确认供暖热水', cid: 21120, ci: '2026-10-22', co: '2026-10-23' },
    'stay-markam':       { p: [360, 500], n: '淡季规划估算价', inc: '2间可分住双床；全屋地暖，县城酒店', cid: 21835, ci: '2026-10-24', co: '2026-10-25' },
    'stay-feilaisi':     { p: [560, 900], n: '淡季规划估算价', inc: '2间可分住；地暖+供氧，观景房近日照金山动线', cid: 3928, ci: '2026-10-25', co: '2026-10-26' },
    'stay-shangrila':    { p: [560, 900], n: '淡季规划估算价', inc: '整套两居或客房2间可分住（全屋供氧，住1晚）', cid: 660, ci: '2026-10-26', co: '2026-10-27' },
    'stay-lijiang':      { p: [360, 700], n: '淡季规划估算价', inc: '首选171㎡两卧三卫带厨房整套（4人一套），或2间可分住；免费停车', cid: 37, ci: '2026-10-27', co: '2026-10-28' },
    'stay-xichang':      { p: [360, 520], n: '规划估算价', inc: '2间可分住（大床+双床）；邛海度假酒店', cid: 141, ci: '2026-10-28', co: '2026-10-29' }
  };
  pois.forEach(poi => {
