(function () {
  ...
  const RESTOCK_NOTE = {
    4: '成都大补给（进藏前唯一一次囤够，撑 D5—D17 拉萨这 13 天）——在成都大型超市/永辉一次配齐：① 自热正餐 约30—36 份，别只买米饭，米饭·麻辣烫·自热米线·酸辣粉·螺蛳粉·自热小火锅各囤一些换口味（服务区赶路日全靠它、发热包无明火）；② 现煮料（到住宿/湖边开炉用）：干米线/米粉/挂面/方便面饼各 1—2 把、常温料理包（红烧牛肉·咖喱鸡·番茄牛腩·鱼香肉丝换口味）8—10 袋、浓汤宝/高汤块若干、螺蛳粉底料几包；③ 蛋白轮换：火腿肠/午餐肉 约20 根/罐、豆干几袋、卤蛋当天煮 16—20 个；④ 异丁烷+丙烷高山混合气罐 3—4 罐（勿买纯丁烷，高原低温点不着）；⑤ 补品：复合维生素、维生素C 各 1 瓶（速食日蔬菜少，随早/午餐补），别买荷叶片苦瓜片这类没营养的。蔬果分批：黄瓜只买 2—3 天量（3—4 天就蔫，先吃），圣女果/胡萝卜各买 5—7 天量，苹果买足能放 10 天（最耐放、单独放别催熟别的、当天然纤维每天 1 个防高原便秘）；蔬果吃完不用等大补给，沿途理塘/巴塘/波密县城随时补。同时取车验车、洗衣。全程不依赖冷冻。',
