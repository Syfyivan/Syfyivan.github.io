...
<div class="gkc-key-note"><strong>最后一站「交付」开始，这是全课最高光的一讲。</strong>今天，我们把"上线"这件事彻底讲透、做扎实——让你的作品变成"发个链接，全世界都能点开"。等开学把这个链接甩进新生群、发给室友的那一刻，就是你这个暑假的毕业典礼。</div>

<div class="gkc-note"><strong>对号入座，看你属于哪种情况：</strong><br>· <strong>你第 07 讲接了 AI</strong>：那你很可能已经有一个能打开的网址了（部署是接 AI 顺带做的）。这一讲帮你<strong>搞懂它背后到底发生了什么</strong>，并把它收拾成正式、能放心发出去的版本。<br>· <strong>你的作品是纯网页（没接 AI）</strong>：那它现在还只在你电脑里，这一讲带你<strong>第一次把它送上线</strong>。<br>不管哪种，读完你都会真正"会上线"——以后做任何新作品都能自己发出去。</div>
...
一个没上线的作品，只住在你电脑里——电脑一关，或者别人不在你身边，就访问不了。

**上线（部署）= 把作品放到一台"永远开着、永远连着网"的电脑（服务器）上，并给它一个网址。** 从此它 7×24 在线，谁都能访问。（第 07 讲接 AI 时让你"部署"，干的就是这件事——只是当时没展开。）
