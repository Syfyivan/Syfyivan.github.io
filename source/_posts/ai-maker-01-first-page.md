...
<div class="aim-key-note"><strong>这一讲，你会真的做出一个网页。</strong>零安装、半小时，你描述一句，它就出现在屏幕上。你还会顺手学到造物者的第一个习惯——<strong>先猜后做</strong>。它就是"自己学会"和"只会喊话"之间那条分水岭。</div>

上一讲你写下了一句"我想做一个 ___"。现在我们让它，第一次，变成屏幕上能看的东西。

## 🎯 这一讲你会做出什么 <span class="aim-b aim-core">必读</span>

你对 AI 说一段话——你的名字、一句自我介绍、你喜欢的几样东西。几秒钟后，浏览器里出现一张属于你的网页：顶上是你的名字，下面是介绍和"我喜欢的"。然后你动几下嘴皮子，它就换颜色、加板块、改文字。
...
为什么把它放在第一位？因为"看 AI 做"和"自己学会"之间，差的就是这一下。光看，AI 一关掉你就空了；先逼自己猜一下，脑子被迫先转一圈，知识才会长在你身上，而不是长在 AI 身上。

接下来每一步，我都会先让你"猜猜看"。**别跳过那一下**，它才是你真正在学的地方。
...
**第 0 步 · 找一个能聊天的 AI。** 用任意一个你能稳定打开的 AI 就行。最爽的是带"**实时预览**"的——你描述，它在旁边直接把网页画出来。海外的 Claude、ChatGPT 这类有；国内能直连的豆包、通义千问、Kimi 等也在做这种预览，**有就用，没有也完全不影响**——第 3 步教你怎么看到它，任何 AI 都行。

**第 1 步 · 先猜（10 秒）。** 在动手前，对自己说一句：*"我把自己介绍给 AI、让它做张网页，出来大概长啥样？"* 有没有图？什么颜色？随便猜，记心里。
...
**第 4 步 · 改三处（这步最爽）。** 每改一处之前，还是**先猜**它会变成啥样，再发给 AI：
...
那 AI 给你的"代码"到底是啥？别怕它。**一个网页，本质就是一个文本文件**，里面用一些"标签"告诉浏览器每一块是什么。比如：
...
看它给你什么。大概率是一个跟你毫无关系、谁都能用的"通用模板"——没有你的名字、没有你喜欢的东西，甚至不知道是干嘛的。

<div class="aim-why"><strong>为什么会这样？</strong>不是 AI 笨，是你没给它信息。你说得越含糊，它就越只能瞎猜、用最大众的默认值填满。对比一下第 2 步那段又臭又长的话——信息给足，它就做得准。<strong>"把想要的说清楚"本身就是一门手艺</strong>，下一讲（第 02 讲）专门教你这个。</div>
...
别照我的，**自己写一句话**，给网页加一样我没让你加的东西——一张你喜欢的图片？一份你的歌单？一个倒数高考……啊不，倒数开学的小牌子？
