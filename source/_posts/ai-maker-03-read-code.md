---
title: "《AI 造物入门》第03讲 · 它给我这坨代码，到底在干嘛？"
date: 2026-06-29 13:00:00
tags: [AI, 编程入门, 零基础, vibe coding, HTML, 读代码, 课程]
categories: [技术笔记]
toc: true
visibility: public
---
...
<div class="aim-key-note"><strong>这一讲练第三个能力：读。</strong>不是教你写代码、背语法，而是让你拿到 AI 给的一坨东西时，能一眼认出"这块是干嘛的"。读得懂个大概，你才说得清哪里要改，也才看得出 AI 有没有糊弄你。</div>
...
## 读代码，像看房子的平面图 <span class="aim-b aim-core">必读</span>
...
## 网页就三类东西：结构 / 样式 / 行为 <span class="aim-b aim-core">必读</span>

不管 AI 给你的代码多长，它基本就在干三件事：

<div class="aim-card"><strong>一张网页 = 结构 + 样式 + 行为</strong><br><strong>结构（HTML）</strong>：页面上"有什么"——标题、段落、图片、按钮<br><strong>样式（CSS）</strong>：这些东西"长什么样"——颜色、大小、间距、位置<br><strong>行为（JS）</strong>：点了之后"会发生什么"——弹窗、变色、跳转</div>

你第 1 周做的那张主页，里面其实就这三样混在一起。学会一眼分出"这段是结构、那段是样式"，代码就不再是一坨，而是三个抽屉。

<div class="aim-note"><strong>怎么快速分辨？</strong>带尖括号的标签（像 <code>&lt;h1&gt;</code>、<code>&lt;p&gt;</code>）多半是<strong>结构</strong>；出现 color、background、font、margin 这些词的，是<strong>样式</strong>；看到 function、click 这类词的，是<strong>行为</strong>。认个大概就行，不用精确。</div>

## 三招，把"看不懂"变成"看个大概" <span class="aim-b aim-core">必读</span>
...
## 🔮 先猜后做：给自己的代码贴标签 <span class="aim-b aim-core">必读</span>

现在动手。打开你第 1 周那张主页的代码，从上往下，**一块一块先自己猜**："这块大概是干嘛的？"——猜完，再用第 1 招让 AI 加上人话注释，对照你猜得对不对。
...
<div class="aim-why"><strong>这就是"读"的价值。</strong>如果你完全不看，这个"假按钮"就这么上线了，你还以为做好了。能读个大概，你才能发现"它说做了，其实没做全"。AI 不是故意骗你，但它确实会出错、会画蛇添足——<strong>你这双能扫一眼的眼睛，就是质量的最后一道关。</strong>这一点，第 12 讲我们还会专门展开。</div>
...
<div class="aim-card"><strong>📦 复制带走</strong><br>① 读代码像看平面图：<strong>认房间，不数砖</strong>。<br>② 网页就三类：<strong>结构（有什么）/ 样式（长啥样）/ 行为（能干啥）</strong>。<br>③ 看不懂的万能第一招：<strong>让 AI 加"人话注释"</strong>。<br>④ 能读个大概，你才看得出 AI 有没有糊弄你。</div>

会描述、会说清、会读懂——第 1 周，你已经把"和 AI 协作"的地基打好了。下一周我们揭开盖子：你做的这些东西，到底**存在哪、怎么跑起来的**。下一讲**第 04 讲**，我们把作品从聊天框里搬出来，放进一个真正的"工作台"。
