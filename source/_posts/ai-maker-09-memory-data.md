---
title: "《AI 造物入门》第09讲 · 让它记住事、会翻资料（给作品一点记忆）"
...
<div class="aim-why">这两种坑都在提醒你：<strong>"记住"和"翻资料"，都是要专门做对的事，不会自动发生。</strong>而你现在能分辨问题出在"没存上"还是"没翻到"——这正是第 05 讲那张地图、第 06 讲那套流程，给你的底气。</div>
...
第 3 周收工！你的作品现在能对话、有灵魂、（也许）还有记忆。但它还只活在你自己的电脑上。下一周，我们做最爽的一件事——**把它送上线，变成一个谁都能点开的网址**。下一讲 **第 10 讲**，见证高光时刻。
