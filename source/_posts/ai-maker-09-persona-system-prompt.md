---
title: "《AI 造物入门》第09讲 · 给你的 AI 一个人设：做一个“你的数字分身”"
...
<div class="aim-note">上一讲用的现成模板里，一般都有一处专门放"系统提示 / system prompt / 角色设定"的地方。找不到就直接问 AI："我这个模板，该把 system prompt 填在哪里？"</div>
...
<div class="aim-why"><strong>AI 不知道也会硬答，这是它的天性，不是它使坏。</strong>你给的事实和边界，就是给它套的缰绳。"AI 会一本正经地胡说"这件事有多重要、怎么防，第 12 讲会专门讲——你现在先养成习惯：给人设，必给事实 + 给边界。</div>
...
你的分身有灵魂了。但它现在只知道你"写死"在人设里的那点事。下一讲 **第 10 讲**（选学进阶），我们让它能"翻资料"、能"记住事"——给它一点真正的记忆。
