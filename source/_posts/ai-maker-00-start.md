...
如果你想试试编程和 AI，多半翻开过一份教程——

第一页：变量。第二页：循环。第三页：函数。翻到第四页，就悄悄关上了。

没关系，几乎每个人都是这样。这门课，我们不从那里开始。
...
<div class="aim-key-note"><strong>我们卸载的是语法，不是你的判断。</strong>那些查字典式的死记硬背（标签怎么拼、函数叫什么名字）交给 AI；但该由你来的——想清楚要做什么、把要求讲明白、看懂它给的东西、它错了你能修——一样都不替你做。这样你最后会成为一个能指挥 AI 的人，而不是 AI 一旦不在、就不知道往下怎么走的人。</div>
...
你不是来"当程序员"的，你是来**当导演**的。美术、敲代码、写文案，AI 这个剧组全包；你负责的是：想清楚要拍什么、把要求讲明白、看回放、说一句"这里再来一遍"。好导演不需要会演每一个角色。

而"独立"的底气，是下面这四个换任何工具都不过时的能力——整门课，其实都在悄悄练它们：
...
每一讲，我都会让你做两个小动作，专门防止你变成"只会喊话"的人：**先猜后做**（AI 出手前，先猜它会怎么写）、**周末裸考**（关掉 AI，自己过一小关）。别担心，到时候你会感谢这两个动作。
...
- 我想做一个**个人主页**，它能**用我的语气回答别人对我的提问**，我想发给**新认识的朋友**看。
- 我想做一个**"今天吃什么"小工具**，它能**帮纠结的我随机选一家**，我想发给**室友**看。
- 我想做一个**复习速查页**，它能**让我考前快速翻**，我想发给**同学**看。
