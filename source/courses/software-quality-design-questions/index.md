...
html[data-user-color-scheme="dark"] .sqd-figure {
  background: #ffffff;
}
html[data-user-color-scheme="dark"] .sqd-copy-answer {
      ...
      <pre class="sqd-code">int main(int x, y, z)
{
  ...
  return n;
    ...
    <article class="sqd-card">
      ...
      <h3>先把代码翻译成人话</h3>
      <ul class="sqd-list">
        <li>程序一开始固定做 <code>n=1</code>。</li>
        <li>第一个 <code>if</code> 问：<code>x&gt;0</code> 或 <code>y&lt;0</code> 有没有一个成立？成立就加 <code>x</code>，不成立就加 <code>y</code>。</li>
        <li>第二个 <code>if</code> 问：<code>z&gt;0</code> 吗？成立就再加 <code>z</code>，不成立就不加。</li>
        <li>最后返回 <code>n</code>。所以这题的关键就是控制两个判断的真和假。</li>
      </ul>
    </article>
  </div>
  ...
  <div class="sqd-answer-pack">
    <article class="sqd-step-card">
      <h3>第 0 步：先找出两个判断点</h3>
      <p>零基础做这种题，不要一上来画图。先把会分叉的地方圈出来。本题只有两个判断点：D1 是 <code>x&gt;0 || y&lt;0</code>，D2 是 <code>z&gt;0</code>。D1 为真走 <code>n=n+x</code>，D1 为假走 <code>n=n+y</code>；D2 为真执行 <code>n=n+z</code>，D2 为假直接返回。</p>
      <div class="sqd-table-wrap" style="margin-top:12px">
        <table class="sqd-table">
          ...
          <tbody>
            <tr>
              ...
              <td>只要 <code>x&gt;0</code> 或 <code>y&lt;0</code> 有一个成立，就走 <code>n=n+x</code>。</td>
              <td>要让“或”整体为假，必须 <code>x&lt;=0</code> 且 <code>y&gt;=0</code>，走 <code>n=n+y</code>。</td>
              <td>D1 真可取 <code>x=1,y=0</code>；D1 假可取 <code>x=0,y=0</code>。</td>
            </tr>
            <tr>
              <td>D2：<code>z&gt;0</code></td>
              <td>走 <code>n=n+z</code>。</td>
              <td>跳过 <code>n=n+z</code>，直接 <code>return n</code>。</td>
              <td>D2 真可取 <code>z=1</code>；D2 假可取 <code>z=0</code>。</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table class="sqd-table">
          ...
          <tbody>
            <tr>
              ...
              <td>D1 真，D2 真。</td>
              <td><code>n=1</code>、<code>n=n+x</code>、<code>n=n+z</code>、<code>return n</code>。</td>
              <td><code>3</code></td>
            </tr>
            <tr>
              <td>T2</td>
              ...
              <td>D1 假，D2 假。</td>
              <td><code>n=1</code>、<code>n=n+y</code>、<code>return n</code>。</td>
              <td><code>1</code></td>
            </tr>
          </tbody>
        </table>
    ...
    <article class="sqd-step-card">
        ...
        <table class="sqd-table">
          ...
          <tbody>
            <tr>
              ...
              <td>D1 真 -> D2 真</td>
              <td><code>x=1, y=0, z=1</code></td>
              <td><code>1 + x + z = 1+1+1</code></td>
              <td><code>3</code></td>
            </tr>
            <tr>
              <td>P2</td>
              <td>D1 真 -> D2 假</td>
              <td><code>x=1, y=0, z=0</code></td>
              <td><code>1 + x = 1+1</code></td>
              <td><code>2</code></td>
            </tr>
            <tr>
              <td>P3</td>
              <td>D1 假 -> D2 真</td>
              <td><code>x=0, y=0, z=1</code></td>
              <td><code>1 + y + z = 1+0+1</code></td>
              <td><code>2</code></td>
            </tr>
            <tr>
              <td>P4</td>
      ...
      <section class="sqd-note">
        <p><strong>特别注意：</strong>如果题目问“基本路径测试”，这段代码有 2 个判断，所以环路复杂度 <code>V(G)=2+1=3</code>，基本路径通常写 3 条独立路径。但这道 A 卷小题问的是“路径覆盖”，所以要写 4 条完整路径。</p>
      </section>
    </article>
  </div>
