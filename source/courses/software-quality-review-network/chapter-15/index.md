...
description: "《软件质量与测试》期末复习二级章节页：验收测试：交付前确认、用户参与、Alpha/Beta。面向零基础同学，整理本章知识点、资料对照、简答模板和自测题。"
---
...
<tbody>
<tr><td>验收测试</td><td>交付前确认</td><td>定义题</td></tr><tr><td>验收依据</td><td>合同、需求、流程、标准</td><td>填空</td></tr><tr><td>UAT</td><td>用户按真实业务确认</td><td>选择</td></tr><tr><td>Alpha/Beta</td><td>开发方受控 / 外部真实环境</td><td>对比</td></tr>
</tbody>
</table>
</div>
