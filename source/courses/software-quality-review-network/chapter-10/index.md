...
description: "《软件质量与测试》期末复习二级章节页：软件测试：目标、原则、过程、用例、调试。面向零基础同学，整理本章知识点、资料对照、简答模板和自测题。"
---
...
<div><strong>资料来源</strong><p>测试基本理论、2024 回忆、待核课堂练习线索</p></div>
...
<tbody>
<tr><td>测试定义</td><td>为发现错误而执行程序</td><td>填空</td></tr><tr><td>测试原则</td><td>需求追溯、尽早、缺陷群集、回归</td><td>选择判断</td></tr><tr><td>测试用例</td><td>输入 + 预期输出 + 条件步骤</td><td>填空</td></tr><tr><td>测试/调试</td><td>发现错误 / 定位修正</td><td>对比题</td></tr>
</tbody>
</table>
</div>
