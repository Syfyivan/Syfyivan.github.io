...
description: "《软件质量与测试》期末复习二级章节页：软件质量工程体系：质量体系、质量因素、质量成本。面向零基础同学，整理本章知识点、资料对照、简答模板和自测题。"
---
...
<tbody>
<tr><td>质量体系</td><td>方针、目标、职责、资源、过程、改进</td><td>简答题</td></tr><tr><td>QC</td><td>测量和纠正</td><td>和 QA 对比</td></tr><tr><td>QA</td><td>计划化、组织化、提供信任</td><td>和测试对比</td></tr><tr><td>质量成本</td><td>预防、评价、内部失效、外部失效</td><td>互评简答</td></tr>
</tbody>
</table>
</div>
