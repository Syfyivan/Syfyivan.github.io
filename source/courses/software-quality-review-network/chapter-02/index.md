...
description: "《软件质量与测试》期末复习二级章节页：软件质量：软件特点、软件过程、缺陷、质量模型。面向零基础同学，整理本章知识点、资料对照、简答模板和自测题。"
---
...
<tbody>
<tr><td>软件特点</td><td>无形、复杂、易变、不磨损</td><td>判断软件质量为什么难控</td></tr><tr><td>缺陷</td><td>内部问题 + 外部失效</td><td>简答或判断</td></tr><tr><td>过程</td><td>需求、设计、编码、测试、维护</td><td>排序和配对题</td></tr><tr><td>质量模型</td><td>ISO、McCall、Boehm</td><td>互评简答</td></tr>
</tbody>
</table>
</div>
