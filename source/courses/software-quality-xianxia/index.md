...
<div class="sqx-track">
  ...
  <section class="sqx-note">
    <p>新增了<a href="/courses/software-quality-exercises/">概念练习区</a>作为修仙版的小测入口：按 00 引子到 09 炼码境和软件测试、白盒、黑盒、集成、系统、验收测试分组，题干常显、答案折叠。蓝墨云班课和互评老师答案尚未导出，练习区先用于概念检查，不能当原题库。</p>
  </section>
  <section class="sqx-note">
