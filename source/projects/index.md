...
<div class="workshop-page">
  <header class="ws-hero">
    ...
    <div class="ws-hero-stats">
      <div class="ws-stat"><strong>7</strong><span>个自研项目</span></div>
  ...
  <div class="ws-grid">
    ...
    <article class="ws-card ws-card--rust">
      <div class="ws-card-head">
        ...
        <span class="ws-tag ws-tag--self">自研</span>
        <span class="ws-card-repo">pindou-studio</span>
      </div>
      <h3>豆格工坊</h3>
      <p class="ws-card-sub">Photo → Cartoon → MARD Pattern</p>
      <p class="ws-card-desc">把照片先做本地卡通化，再生成带 MARD 色号的拼豆图纸；复杂度、五官、连续眼镜和挂饰连接都可以单独调整，图片不会上传服务器。</p>
      <div class="ws-chips">
        <span class="ws-chip">Canvas</span>
        <span class="ws-chip">Pixel Art</span>
        <span class="ws-chip">Local-first</span>
      </div>
      <div class="ws-card-foot">
        <a class="ws-read" href="/pindou-studio/">打开豆格工坊 →</a>
      </div>
    </article>
  </div>
  <div class="ws-section-head">
  ...
  <div class="ws-grid">
    ...
    <article class="ws-card ws-card--blue">
      <div class="ws-card-head">
        <span class="ws-card-no">WS-09</span>
        <span class="ws-tag ws-tag--study">源码学习</span>
