(function attachMard221Palette(root, factory) {
  const palette = factory();
  if (typeof module === 'object' && module.exports) module.exports = palette;
  if (root) root.Mard221Palette = palette;
}(typeof globalThis !== 'undefined' ? globalThis : this, () => {
  'use strict';

  // Screen-reference HEX values cross-checked against the public MARD 221 chart at pindou.online.
  // Physical bead colours can vary by lighting, display and production batch.
  return [
  ...
  ].map(([code, hex]) => ({ code, name: `MARD ${code}`, hex }));
}));
